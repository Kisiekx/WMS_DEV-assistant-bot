...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(interaction.member.roles.cache.some(role => role.id === '1060912823187816549')){
            ...
            const currentCode = await codesCollection.findOne({value: interaction.options.getString('code'), isActive: true})
                   ...
                   embeds: [
                       {
                           "type": "rich",
                           "title": "ERROR! ❌",
                           "description": `Nie znaleziono altywnego zaproszenia z kodem: \`${interaction.options.getString('code')}\``,
                           "color": 0xff0000,
                           "image": {
                               "url": ``,
                               "height": 0,
